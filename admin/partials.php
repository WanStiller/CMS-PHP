...
<h4 class="page-title">Partials  </h4>
...
<style type="text/css">
	/*textarea{
    background: url(../images/2cOaJ.png);
...
<textarea id="txCodigo" rows="10" cols="70" onkeyup="numeracion(event);"></textarea>
<!-- quite unas cuantas filas para que se vea todo el resultado-->
<h4 id="areaNumeracion"></h4>
...
<textarea  name="pagedescription"  required style="width: 100%" rows="5"><?php echo htmlentities($row['Description'])?></textarea><!---->
</div>
</div>
</div>
<?php } ?>
