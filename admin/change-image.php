...
{
echo "<script>alert('Formato no permitido, solo se permite jpg / jpeg/ png /gif');</script>";
}
else
{
								...
								<div class="page-title-box">
                                    ...
                                    <ol class="breadcrumb p-0 m-0">
                                        ...
                                        <li>
                                           ...
                                           <li>
                                            <a href="#"> Editar Art&iacute;culos </a>
                                        </li>
                                        <li class="active">
                                           Actualizar Imagen
                                        </li>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Archivo en uso</b></h4>
<img src="../uploads/<?php echo htmlentities($row['PostImage']);?>" width="300"/>
<br />
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Subir nueva imagen</b></h4>
