...
<!-- Featured News Slider Start -->
    <div class=" mb-3 mt-3" style="border-top: 0px solid black">
        <div class="container-fluid">
            <div class="section-title bg-dark" style="border:0px">
                <h4 class="m-0 text-uppercase font-weight-bold text-secondary">Continue navigating ...</h4>
            </div>
            <div class="owl-carousel news-carousel carousel-item-4 position-relative">
                            ...
                            $query=mysqli_query($con,"select tblposts.id as pid,tblposts.PostTitle as posttitle,tblposts.slug as slug,tblposts.alt_uploaded as alt_uploaded,tblposts.Views as views,tblposts.Description as description,tblposts.PostImage,tblcategory.CategoryName as category,tblcategory.id as cid,tblsubcategory.Subcategory as subcategory,tblposts.PostDetails as postdetails,tblposts.PostingDate as postingdate,tblposts.PostUrl as url from tblposts left join tblcategory on tblcategory.id=tblposts.CategoryId left join  tblsubcategory on  tblsubcategory.SubCategoryId=tblposts.SubCategoryId where tblposts.Is_Active=1 ORDER BY rand() desc LIMIT $offset, $no_of_records_per_page");
