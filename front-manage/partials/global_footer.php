<div class="container-fluid bg-dark pt-5 px-sm-3 px-md-5 mt-4" style="opacity: 0.4">
        <div class="row py-4">
    ...
    <div class="container-fluid py-4 px-sm-3 px-md-5" style="background: #111111;opacity: 0.4">
    <!--TEXT FOOTER GLOBAL-->
    <?php
    $pagetype='footer';
