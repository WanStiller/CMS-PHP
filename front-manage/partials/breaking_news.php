        ...
        <div class="container-fluid">
            <div class="row align-items-center bg-dark">
                ...
                while ($row=mysqli_fetch_array($query)) {
                        ...
                        <div class="text-truncate text-center"><a class="text-white text-uppercase font-weight-semi-bold" href="article.php?nid=<?php echo htmlentities($row['pid'])?>/<?php echo htmlentities($row['slug'])?>"><?php echo htmlentities($row['Description'])?></a></div>
